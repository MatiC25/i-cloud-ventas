            ...
            <div className="p-4 border-t border-slate-800 bg-slate-900">
                ...
                {user?.role === 'admin' && (
                    <button 
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-2 rounded-lg mb-4 text-sm transition-colors ${
                            activeTab === 'settings' ? 'text-blue-400 bg-slate-800' : 'text-slate-500 hover:text-white'
                        }`}
                    >
                ...
                <div className="flex items-center justify-between px-2 pt-2">
                    <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-400 to-purple-500 flex items-center justify-center font-bold text-xs shadow-lg">
