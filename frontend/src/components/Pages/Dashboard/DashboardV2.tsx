    ...
    return (
        <div className="min-h-screen bg-[#F5F5F7] dark:bg-slate-950 text-gray-900 dark:text-gray-100 font-sans p-4 md:p-8">
            ...
            >
                ...
                <div>
                    <h1 className="text-3xl font-semibold tracking-tight">IConnect Dashboard <span className="text-sm font-normal text-blue-500 bg-blue-100 dark:bg-blue-900/30 px-2 py-1 rounded-full">V2</span></h1>
                    <p className="text-gray-500 mt-1">Saldos de cuentas y rendimiento operativo. <span className="text-xs text-gray-400">(Cards expandibles)</span></p>
                </div>
